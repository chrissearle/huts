...
<head>
  ...
  <title><g:message code="notice.edit.title" args="${[noticeInstance.title]}"/></title>
</head>
<body>
<div class="body">
  <h3 class="formtitle"><g:message code="notice.edit.title" args="${[noticeInstance.title]}"/></h3>
