  ...
  <g:form action="save" method="post">
    <div class="dialog">
      <table>
        ...
        <tr class="prop">
          <td valign="top" class="name">
            <label for="longitude"><g:message code="hut.shared.longitude"/></label>
          </td>
    ...
    <div class="buttons">
      <span class="button"><input class="save" type="submit" value="${message(code:'hut.create.create.button')}"/></span>
    </div>
  </g:form>
</div>
</body>
